    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent menuju_MyTicket_Datail = new Intent(context, MyTicket_Detail.class);
                menuju_MyTicket_Datail.putExtra("nama_wisata", getNamaWisata);
                context.startActivity(menuju_MyTicket_Datail);
            }
        });
